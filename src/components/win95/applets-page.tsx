...
export function Win95AppletsPage() {
    return (
        <Frame padding='$6' style={{ maxWidth: 720, margin: '0 auto' }}>
            <Win95Window title='Programs.exe'>
                <Fieldset legend='Installed programs'>
                    <p style={{ margin: '0 0 12px', lineHeight: 1.5 }}>
                        Launch from here or use <strong>Start → Programs</strong> on the taskbar.
                    </p>
                        ...
                        {APPLETS.map((applet) => (
                            <List.Item
                                ...
                                <Frame display='flex' alignItems='center' gap='$2'>
                                    <strong>{applet.exe ?? applet.title}</strong>
                                    {applet.tag && (
                                        <span
                                            style={{
                                                fontSize: 10,
